...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Gelen verileri değişkenlere alıyoruz. Veri yoksa 'Belirtilmedi' yazdırıyoruz.
    ...
    // Checkbox işaretlenmişse (on) Onaylandı, değilse Onaylanmadı kabul ediyoruz
                                ...
                                <table class="table table-bordered table-hover align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success">' . htmlspecialchars($onay) . '</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
